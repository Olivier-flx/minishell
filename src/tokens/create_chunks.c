...
/*   Updated: 2025/05/14 15:31:38 by ofilloux         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	handle_chunk_before_pipe(t_data *data, char **tokens, int start, int end)
{
	char	**sub_tokens;
...
void	handle_chunk_after_last_pipe(t_data *data, char **tokens, int start, int end)
{
	char	**sub_tokens;
...
int	create_main_chunks(char *src, t_dlist **cmd_list, t_data *data)
{
	...
	print_pp_char_arr(all_tokens); // @debug

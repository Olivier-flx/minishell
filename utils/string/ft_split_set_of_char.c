...
/*   Updated: 2025/06/04 12:01:28 by ofilloux         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	**ft_new_str_arr(char *s, char **ns_ar, int nb_segment, \
		t_int_array *separators)
{
	int		i;
	int		segment_i;
	t_quote	quote;
...
// cc ./utils/string/ft_split_set_of_char.c ./src/tokens/operador.c
// ./utils/string/basics.c ./utils/string/quotes.c -g -o test

//cc -g -O0 -o test ./utils/string/ft_split_set_of_char.c .
///utils/string/basics.c ./src/tokens/token_separators.c
//./src/tokens/operator.c ./utils/string/quotes.c ./utils/arrays/methods.c
...
// 	//new_string = split_quoted("he\"l\"lo > \"le '  ' fcdf  \"    Yo", ' ');
// 	//new_string = split_quoted2(" h\"e\">>'l<'>o  !\" ces\"T\"
//  > l>e 'nouv\"e a u\"    monde !'  | ce'st' s\"ur\"");
// 	//new_string = split_quoted("hello > 'le fcdf monde'
// | cest'   ' pas moi      moi", ' ');
// 	printf("----------array operators ------------ \n");
// 	fflush(stdout); // @debug
// 	print_int_arr(&(data.tok_sep_char_i));
